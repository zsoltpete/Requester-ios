...
extension RPopUpView: RPopUpViewContract {
    ...
    ///Before bind you need to set completitions
    func bind(_ model: RPopUpViewBindable) {
        self.dataSource = RPopUpViewDataSource(model: model, agreeCompletition: agreeCompletition, disagreeCompletition: disagreeCompletition, neverCompletition: neverCompletition)
